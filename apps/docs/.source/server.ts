...
export const docs = await create.docs(
  ...
  "content/docs",
  {
    ...
    "bot/meta.json": __fd_glob_1,
    "deployment/meta.json": __fd_glob_2,
    "packages/meta.json": __fd_glob_3,
    "web/meta.json": __fd_glob_4,
  },
  {
    "architecture.mdx": __fd_glob_5,
    "index.mdx": __fd_glob_6,
    "quickstart.mdx": __fd_glob_7,
    "bot/configuration.mdx": __fd_glob_8,
    "bot/index.mdx": __fd_glob_9,
    "bot/platforms.mdx": __fd_glob_10,
    "deployment/environment.mdx": __fd_glob_11,
    "deployment/index.mdx": __fd_glob_12,
    "packages/ai.mdx": __fd_glob_13,
    "packages/auth.mdx": __fd_glob_14,
    "packages/db.mdx": __fd_glob_15,
    "packages/index.mdx": __fd_glob_16,
    "packages/types.mdx": __fd_glob_17,
    "packages/ui.mdx": __fd_glob_18,
    "web/chat-api.mdx": __fd_glob_19,
    "web/index.mdx": __fd_glob_20,
    "web/models.mdx": __fd_glob_21,
